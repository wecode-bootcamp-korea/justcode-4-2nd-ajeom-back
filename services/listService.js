...
const getDrawerPostList = async (page, pageSize, userId) => {
  try {
    ...
    const getDrawerPostList = await listDao.getDrawerPostList(start, pageSize, userId)
...
const getProfilePostList = async (page, pageSize, userId) => {
  try {
    ...
    const getProfilePostList = await listDao.getProfilePostList(start, pageSize, userId)
